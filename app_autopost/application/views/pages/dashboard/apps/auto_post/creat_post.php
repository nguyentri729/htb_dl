...
<div class="form-group">
       ...
       <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="ngay" required="" value="<?=date("m/d/Y")?>">
</div>

<div class="form-group">
     <strong>* Lặp lại bài đăng sau (phút):  </strong>
    <input type="number" class="form-control" value="0" placeholder="Điền 0 để ko lặp lại" name="repeat" id="repeat_t" />
</div>

<div class="form-group repeat_n" style="display: none;">
     <strong>* Số lần lặp lại:  </strong>
    <input type="number" class="form-control" value="0" placeholder="Điền 0 nếu muốn lặp vĩnh viễn" name="num_repeat" id="repeat_n" required="" />
</div>
