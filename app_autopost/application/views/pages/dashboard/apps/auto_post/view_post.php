               ...
               <section class="post-footer">
                   ...
                   <div class="post-footer-option container">
                        <ul class="list-unstyled text-center">
                            ...
                            <?php
                            if(time() >= $posts['time_post'] && $posts['posted'] == 1){
                              echo '<li ><a href="#" style="color: #4CAF50!important;" ><i class="fa fa-check"></i> Đã đăng bài</a></li>';
                            }
                            ?>
                            <?php
                            if($posts['time_repeat'] > 0){
                              if($posts['num_repeat'] > 0){
                                echo '<li ><a href="#" style="color: #03a9f4!important;" ><i class="fa fa-repeat"></i> Lặp lại '.number_format($posts['num_repeat']).' lần nữa ('.round($posts['time_repeat'] / 60).' phút mỗi lần)</a></li>';
                              }else{
                                 echo '<li ><a href="#" style="color: #03a9f4!important;" ><i class="fa fa-repeat"></i> Bài này sẽ lặp VÔ HẠN nếu bạn không tắt nó.Lặp lại '.number_format($posts['num_repeat']).' lần nữa ('.round($posts['time_repeat'] / 60).' phút mỗi lần)</a></li>';
                              }
...
if($query->num_rows() > 0){
  echo'
 <center>
   <a type="button" href="?delete_posted=1" class="btn btn-danger btn-sm" >Xóa các bài đã đăng</a> </center>';
 }
