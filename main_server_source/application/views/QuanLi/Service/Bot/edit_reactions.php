                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="number" name="max_post_ngay" placeholder="Kết thúc tương tác" class="form-control" value="<?=$data_khachhang['max_post_ngay']?>" max="999" min="10">
                                </div>
                            </div>
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
			...
			<hr>
			<a href="/QuanLi/Services/Bot/Reactions/" class="btn btn-default btn-block">Quản lý khách hàng</a>
        </div>
    </div>
</div>
