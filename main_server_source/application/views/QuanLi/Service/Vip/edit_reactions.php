...
?>
					  	...
					  	<div class="form-group">
					  		...
					  		<div class="checkbox">
					  			<?php
								 	$cx = explode('|', $data_khachhang['cam_xuc_su_dung']);
								 	for ($i=1; $i < 7; $i++) { 
								 		if(in_array($i, $cx)){
								 			$check = 'checked=""';
								 		}else{
								 		...
								 		?>
			                                ...
			                                <label style="padding: 0 4% 0 4%;">
			                                    <input type="checkbox" name="cam_xuc[]" value="<?=$i?>" <?=$check?>> <?=$this->m_func->name_reactions($i)?>
			                                </label>
								 		<?php
								 	}
	...
	<div class="row">
		<div class="col-md-12">
					  	<div class="form-group">
					  		...
					  		<input type="number" name="so_luong_dung" id="so_luong_dung" placeholder="Số like dùng" class="form-control" value="<?=$data_khachhang['so_luong_dung']?>"  required="">
					  	</div>
		</div>
		...
		<div class="col-md-12">
					  	<div class="form-group">
					  		...
					  		<input type="number" name="so_luong_lan" id="so_luong_lan" placeholder="Số like mỗi lần" class="form-control" value="<?=$data_khachhang['so_luong_lan']?>" required="">
...
<div class="col-md-4">
		...
		<div class="panel-body">
			...
			?>
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><b>Like tối đa:  </b><a href="#" class="btn btn-xs btn-primary" style="float: right;;" id="max_like"><?=number_format($data_package['so_luong'])?></a></li>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<a href="/QuanLi/Services/Vip/Reactions/" class="btn btn-primary btn-block">Quản lý khách hàng</a>
		</div>
	</div>	
