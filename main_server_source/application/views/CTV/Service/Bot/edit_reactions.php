                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="number" name="max_post_ngay" placeholder="Kết thúc tương tác" class="form-control" value="<?=$data_khachhang['max_post_ngay']?>" max="9999999" min="10">
                                </div>
                            </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <ul class="list-group">
                ...
                <?php $tt= $this->m_reactions->thanh_tien(0, $this->session->userdata('ctv_id')); ?>
			...
			<hr>
			<a href="/CTV/Services/Bot/Reactions/QuanLyKhachHang" class="btn btn-default btn-block">Quản lý khách hàng</a>
        </div>
    </div>
</div>
