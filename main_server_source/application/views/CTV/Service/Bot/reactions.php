			...
			<form action="" method="POST" class="form" role="form" id="form_reactions">
					...
					<div class="tab-content">
					  <div id="home" class="tab-pane fade in active">
					  	...
					  	<div class="form-group">
					  		<label>* Cảm xúc : </label><br>
					  		<div class="checkbox">
					  			<label style="padding: 0 4% 0 4%;">
					  				<input type="checkbox" name="cam_xuc[]" value="1">
					  				Thích
					  			</label>
	...
	<div class="row">
		<div class="col-md-4">
					  	<div class="form-group">
					  		...
					  		<input type="number" name="post_mot_lan" placeholder="Bài tương tác /phút" class="form-control" value="5" max="50" min="1">
		...
		<div class="col-md-4">
					  	<div class="form-group">
					  		...
					  		<input type="number" name="khoang_cach_lan" placeholder="Kết thúc tương tác" class="form-control" value="5" min="1">
					  	</div>
		</div>
		...
		<div class="col-md-4">
					  	<div class="form-group">
					  		...
					  		<input type="number" name="max_post_ngay" placeholder="Kết thúc tương tác" class="form-control" value="3000" max="99999999" min="10">
					  	</div>
		</div>
							...
							<div class="row">
								<div class="col-md-6">
											  	<div class="form-group">
											  		...
											  		<input type="number" name="age_start" placeholder="Bắt đầu tương tác" class="form-control" value="15">
											  	</div>
								</div>
								<div class="col-md-6">
											  	<div class="form-group">
											  		<label>* Đến(tuổi): </label><br>
											  		<input type="number" name="age_end" placeholder="Kết thúc tương tác" class="form-control" value="35">
											  	</div>
								</div>
							</div>
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<ul class="list-group">
				...
				$tt = $this->m_reactions->thanh_tien(10, $this->session->userdata('ctv_id'));
				?>
			...
			<hr>
			<a href="/CTV/Services/Bot/Reactions/QuanLyKhachHang" class="btn btn-info btn-block">Quản lý khách hàng</a>
		</div>
	</div>
</div>
...
<code>Ib|ib|Giá|giá|CTV|ctv|Đại lý|đại lý|Mua|mua|Bán|bán|Áo|áo|Quần|quần|Váy|váy|Giày|giày|Đồ|đồ|Ốp|ốp|Size|size|sz|Sale|saleShip|ship|Iphone|iphone|Samsung|samsung|Oppo|oppo|Hàng|hàng|Đơn|đơn|Chốt|chốt|Hàng|hàngFree|free|Live|live|Sỉ|sỉ|Lẻ|lẻ|New|new|Tặng|tặng|Túi|túi|Kem|kem|Son|son|Mẫu|mẫu|#
</code>
