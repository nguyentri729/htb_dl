    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <center>
                ...
                <a href="/CTV/Services/Bot/Comment/QuanLyKhachHang" class="btn btn-default"><i class="fa fa-chevron-left" aria-hidden="true"></i>
 Quay Lại</a>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="add_bl">
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" rows="3" name="message" id="noi_dung" placeholder="Nội dung bình luận"></textarea><br>
                                          <small class="text-muted">
                                              <code>[random_icon]</code> : Icon ngẫu nhiên<br>
                                              <code>[tag]</code> : Tag người đăng status<br>
                                              <code>tag=4=tag</code> : Thay 4 bằng id cần tag
                                          </small>
                                      </div><hr>
