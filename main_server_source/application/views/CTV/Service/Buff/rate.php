<div class="col-md-8">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">Dịch vụ tăng rate Fanpage</h3>
		</div>
			...
			<form action="" method="POST" role="form" id="form_buff">
					...
					<div id="change">
						<div class="form-group">
							...
							<input type="number" name="so_luong" class="form-control" placeholder="Mua nhiều sẽ được giảm giá <3" id="so_luong" value="0" min="50">
						</div>
					...
					<div class="form-group">
						...
						<button type="submit" class="btn btn-primary" id="submit_btn">Tiến hành tăng rate</button>
