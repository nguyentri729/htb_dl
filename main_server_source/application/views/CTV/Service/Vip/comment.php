...
<div class="col-md-8">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">Cài đặt dịch vụ VIP Comment</h3>
		</div>
					  		...
					  		<div class="col-md-6">
							  	<div class="form-group">
							  		...
							  		<select name="loai_acc_tuong_tac" id="loai_tuong_tac" class="form-control" required="required">
							  			<option value="1">Người dùng thật</option>
...
<div id="time_tt" class="tab-pane fade">
	...
	<div class="row">
		...
		<div class="col-md-12">
					  	<div class="form-group">
					  		<label>* Số bình luận/lần :  </label><br>
...
<div class="col-md-4">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<ul class="list-group">
				...
				<li class="list-group-item"><b>Comment tối đa:  </b><a href="#" class="btn btn-xs btn-primary" style="float: right;;" id="max_like"><?=$arr_html['max_like']?></a></li>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<a href="/CTV/Services/Vip/Comment/QuanLyKhachHang" class="btn btn-primary btn-block">Quản lý khách hàng</a>
		</div>
	</div>	
