      ...
      <h3 class="text-center text-info">CÁC DỊCH VỤ CUNG CẤP</h3><hr>
        			...
        			<div class="panel-body text-center">
        				...
        				<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Bot/Reactions">
							...
							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Bot/Comment">
	        						<div style="padding: 10px">
	        						<i class="fa fa-comments-o fa-3x" aria-hidden="true"></i><br>
	        							<span>Bot bình luận</span>
	        						</div>
	        					</a>			
							</div>
        	...
        	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        		<div class="panel panel-default">
        			...
        			<div class="panel-body text-center">
        				...
        				<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Vip/Reactions">
	        						<div style="padding: 10px">
	        						<i class="fa fa-heart fa-3x" aria-hidden="true"></i><br>
	        							<span>Vip cảm xúc</span>
	        						</div>
	        					</a>			
							</div>	

							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Vip/Comment">
	        						<div style="padding: 10px">
	        						<i class="fa fa-comments-o fa-3x" aria-hidden="true"></i><br>
        			...
        			<div class="panel-body text-center">
        				...
        				<div class="row">
							...
							<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Buff/Like">
	        						<div style="padding: 10px">
							...
							<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Buff/Reactions">
	        						<div style="padding: 10px">
	        						<i class="fa fa-heart fa-3x" aria-hidden="true"></i><br>
	        							<span>Tăng cảm xúc</span>
	        						</div>
	        					</a>			
							</div>	
							...
							<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Buff/Share">
	        						<div style="padding: 10px">
	        						<i class="fa fa-share fa-3x" aria-hidden="true"></i><br>
							...
							<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Buff/Follow">
	        						<div style="padding: 8px;">
	        						<i class="fa fa-rss fa-3x" aria-hidden="true"></i><br>
	        							<span>Tăng follow</span>
	        						</div>
	        					</a>			
							</div>

							<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3" style="padding: 10px;">
	        					<a class="btn btn-default" href="/CTV/Services/Buff/Rate">
	        						<div style="padding: 8px;">
	        						<i class="fa fa-star-o fa-3x" aria-hidden="true"></i><br>
	        							<span>Tăng đánh giá</span>
	        						</div>
	        					</a>			
							</div>
